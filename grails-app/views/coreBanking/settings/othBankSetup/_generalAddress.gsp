...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group ${hasErrors(bean: othBankSetup, field: 'general.state', 'has-error')}">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group ${hasErrors(bean: othBankSetup, field: 'general.city', 'has-error')}">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group ${hasErrors(bean: othBankSetup, field: 'general.streetName', 'has-error')}">
    ...
    <div class="col-xs-12">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group ${hasErrors(bean: othBankSetup, field: 'general.zipCode', 'has-error')}">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group ${hasErrors(bean: othBankSetup, field: 'general.addressLine1', 'has-error')}">
