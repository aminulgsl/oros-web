...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group ${hasErrors(bean: othBranchSetup, field: 'postal.state', 'has-error')}">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group  ${hasErrors(bean: othBranchSetup, field: 'postal.city', 'has-error')}">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group ${hasErrors(bean: othBranchSetup, field: 'postal.streetName', 'has-error')}">
    ...
    <div class="col-xs-12">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group ${hasErrors(bean: othBranchSetup, field: 'postal.zipCode', 'has-error')}">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group ${hasErrors(bean: othBranchSetup, field: 'postal.addressLine2', 'has-error')}">
