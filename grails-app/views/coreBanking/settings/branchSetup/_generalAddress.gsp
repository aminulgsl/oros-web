...
<div class="row">
    <div class="col-xs-12">
        <div class="col-md-4 col-sm-4">
            <div class="form-group  ${hasErrors(bean: branchSetup, field: 'general.country', 'has-error')}">
                <label for="generalCountry">
                    <g:message code="default.country.label" default="Country"/> *
                </label>

                <g:select id="generalCountry" name='general.country' class="form-control" required=""
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group ${hasErrors(bean: branchSetup, field: 'general.state', 'has-error')}">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group ${hasErrors(bean: branchSetup, field: 'general.city', 'has-error')}">
    ...
    <div class="col-xs-12">
        <div class="col-md-4 col-sm-4">
            <div class="form-group ${hasErrors(bean: branchSetup, field: 'general.streetName', 'has-error')}">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group ${hasErrors(bean: branchSetup, field: 'general.zipCode', 'has-error')}">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group ${hasErrors(bean: branchSetup, field: 'general.addressLine1', 'has-error')}">
