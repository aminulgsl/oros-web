...
%{--</div>--}%
    <div class="clearfix">
        <div class="col-md-offset-3 col-md-9">
            ...
            <g:hiddenField name="entryFeeId" value="${entryFeeTable?.id}"></g:hiddenField>
            <g:hiddenField name="reopenFeeId" value="${reopenFeeTable?.id}"></g:hiddenField>
            <g:hiddenField name="closeFeeId" value="${closeFeeTable?.id}"></g:hiddenField>
            <g:hiddenField name="manageFeeId" value="${manageFeeTable?.id}"></g:hiddenField>
