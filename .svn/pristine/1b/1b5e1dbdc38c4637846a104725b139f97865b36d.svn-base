...
<div class="row">
    ...
    <sec:access controller="user" action="create">
        <div class="col-xs-12">
            <span class="navbar-right"><a href="${g.createLink(controller: 'chartGroup',action: 'create')}" id="createChartGroup" class="btn btn-success">Add Chart Group</a></span>
        </div>
    </sec:access>
    <div class="col-xs-12">
...
//            "aaSorting": [[ 1, "desc" ]],
            "bServerSide": true,
            "sAjaxSource": "${g.createLink(controller: 'chartGroup',action: 'list')}",
        ...
        $('#createChartGroup').click(function (e) {
            var control = this;
...
//                    $('#'+updateDiv).html(data);
        ...
        $('#sample-table-2').on('click', 'a.edit-user', function(e) {
            ...
            jQuery.ajax({
                type: 'POST',
                url: "${g.createLink(controller: 'chartGroup',action: 'edit')}?id="+userId,
                success: function (data, textStatus) {
                    $('#page-content').html(data);
                },
                error: function (XMLHttpRequest, textStatus, errorThrown) {
//                    $('#'+updateDiv).html(data);
        ...
        $('#sample-table-2').on('click', 'a.delete-user', function(e) {
         ...
         jQuery.ajax({
         type: 'POST',
         url: "${g.createLink(controller: 'chartGroup',action: 'delete')}?id="+userId,
         success: function (data, textStatus) {
         $('#page-content').html(data);
         },
         error: function (XMLHttpRequest, textStatus, errorThrown) {
