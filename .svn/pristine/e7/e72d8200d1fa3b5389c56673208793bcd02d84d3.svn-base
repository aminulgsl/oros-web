...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#othBankSetUpform").submit(function (e) {
                var actionUrl = "${createLink(controller: 'othBankSetup', action: 'save')}";
...
<body>
<sec:access controller='othBankSetup' action='index'>
    <div class="row">
    %{--message--}%
    ...
    %{--End Message--}%
        <g:hasErrors bean="${othBankSetup}">
            <div class='alert alert-success '>
                <ul>
                    <g:eachError var="err" bean="${othBankSetup}">
        ...
        <div class="col-xs-12">
            <div class="widget-box ">
                ...
                <form class="" id="othBankSetUpform" role="form" method="post">

                    <g:hiddenField name="id" value="${othBankSetup?.id}"/>
                        ...
                        <div class="panel panel-default" id="generalSetting">
                            ...
                            <div class="panel-collapse collapse in" id="collapseOne">
                                <div class="panel-body">
                                    ...
                                    <g:render template="/coreBanking/settings/othBankSetup/generalInformation"/>
                        ...
                        <div class="panel panel-default" id="generalAddress">
                            ...
                            <div class="panel-collapse collapse" id="collapseTwo">
                                <div class="panel-body">
                                    ...
                                    <g:render template="/coreBanking/settings/othBankSetup/generalAddress"/>
                        ...
                        <div class="panel panel-default" id="postalAddress">
                            ...
                            <div class="panel-collapse collapse" id="collapseThree">
                                <div class="panel-body">
                                    ...
                                    <g:render template="/coreBanking/settings/othBankSetup/PostalAddress"/>
                        ...
                        <div class="panel panel-default" id="contactInfo">
                            ...
                            <div class="panel-collapse collapse" id="collapseFour">
                                <div class="panel-body">
                                    ...
                                    <g:render template="/coreBanking/settings/othBankSetup/contactInfo"/>
...
<script type="text/javascript">
    $('#othBankSetUpform').validate({
        ...
        invalidHandler: function (event, validator) { //display error alert on form submit
            $('.alert-danger', $('#othBankSetUpform')).show();
        },
