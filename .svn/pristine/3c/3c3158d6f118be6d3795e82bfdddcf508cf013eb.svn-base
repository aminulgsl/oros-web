        ...
        <div class="col-md-4 col-sm-4">
            <div class="form-group">
                ...
                <g:if test="${bankSetupData?.logo == null}">
                    <ii:imageTag id="preview" indirect-imagename="#" indirect-filedir="ide/sed" alt="Bank Logo" width="140px" height="140px"/>
                </g:if>
                <g:else>
                    <ii:imageTag id="preview" indirect-category="234/543" indirect-imagename="${bankSetupData?.logo}" alt="Bank Logo" width="140px"
                                 height="140px"/>
